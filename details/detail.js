...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (productId && myproducts) {
        ...
        if (product) {
            ...
            // Initialize views and rateviews
            ...
            rateviews = (rateviews ? parseInt(rateviews) : 0); // Start without incrementing

            // Update UI based on product data
            ...
            // Before unloading the page, save the rating
    ...
    // Handle similar products and product list
